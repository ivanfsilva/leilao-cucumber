package br.com.ivanfsilva.leilao.acceptance.steps;

import br.com.ivanfsilva.leilao.e2e.pages.Browser;
import br.com.ivanfsilva.leilao.e2e.pages.LeiloesPage;
import br.com.ivanfsilva.leilao.e2e.pages.LoginPage;
...
public class LeilaoSteps {
    ...
    public void o_novo_leilao_aparece_na_tabela() {
        this.leiloesPage.existe("PC Novo", "1500", "01/11/2021", "fulano");
        this.browser.clean();
    }
}
